...
create_host_helper_bundle() {
    HOST_HELPER_DIR="$(create_host_probe_dir "tc08-docker-rootless-helper")" || cld6001_block "precondition_failed" "Failed to create controlled host helper bundle for TC08"
