...
TC21_RUNTIME_ID="${RUNNER_RUNTIME_ID:-podman-rootless}"
...
tc20_required_artifacts=(
  "test-output.log"
  "tc20-applicability.json"
  "podman-skip-transcript.log"
)
...
append_tc21_log "--- TC21: podman-rootless Current-Run Control-Impact Synthesis ---"
...
append_tc21_log ""
append_tc21_log "Podman current-run control-impact synthesis completed."
